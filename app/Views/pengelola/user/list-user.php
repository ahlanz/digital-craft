                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="<?=base_url()?>/pengelola/dashboard">Digital carft & katalog</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-title-desc">User yang terdaftar pada UMKM dan belum mengisi Biodata</p>
                            </div>
                            <div class="card-body">
