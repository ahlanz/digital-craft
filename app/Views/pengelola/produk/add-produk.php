                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="addPesanan" action="<?=base_url()?>/pengelola/produk/add_proc" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label for="choices-single-default" class="form-label">UMKM</label>
                                                <select class="js-choices form-control" data-trigger name="idumkm" placeholder="This is a search placeholder">
                                                    <option value="">Pilih UMKM...</option>
                                                    <?php foreach ($l_umkm as $b) { ?>
                                                        <option value="<?=$b->idumkm?>"><?=$b->umkm_name?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <a href="<?=base_url()?>/pengelola/produk/list" class="btn text-white" style="background-color: red;">Kembali</a>
