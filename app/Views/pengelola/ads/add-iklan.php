                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" name="ads_name" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <input type="number" name="duration1" class="form-control" required>
                                                    </div>
                                                    <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="ads_price" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="ads_description" id="editor" class="form-control">
                                                    <?=session()->getFlashdata('ads_description')?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
