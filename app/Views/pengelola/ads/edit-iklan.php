                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <!-- <li class="breadcrumb-item active">Ubah Paket Iklan</li> -->
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <!-- <p class="card-title-desc">Ubah Paket Iklan</p> -->
                            </div>
                            <div class="card-body">
                                <?=session()->getFlashdata('notif');?>
                                <!-- <form id="editIklan" action="<?=base_url()?>/pengelola/iklan/edit_proc/<?=$l_detail->idads?>" method="post">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label">Nama Paket <span class="text-danger">*</span></label>
                                                <div class="col-sm-12">
                                                    <input type="text" value="<?=$l_detail->ads_name?>" name="ads_name" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <input type="number" value="<?=$l_detail->ads_duration?>" name="duration1" class="form-control" required>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <select name="duration2" class="form-control" disabled>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="<?=$l_detail->ads_price?>" name="ads_price" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Deskripsi Paket</label>
                                                <textarea name="ads_description" id="editor" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <a href="<?=base_url()?>/pengelola/iklan/list" class="btn btn-secondary">Kembali</a>
